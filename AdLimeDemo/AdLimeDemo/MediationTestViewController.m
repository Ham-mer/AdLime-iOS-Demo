...
@interface MediationTestViewController ()<AdLimeBannerViewDelegate, AdLimeInterstitialAdDelegate, AdLimeNativeAdDelegate, AdLimeRewardedVideoAdDelegate>
...
- (void)testBanner {
    ...
    AdLimeBannerView *bannerView = [[AdLimeBannerView alloc] initWithAdUnitId:(NSString *)BANNER_ADUNITID[self.adxIndex] rootViewController:self];
...
- (void) loadInteristial {
    ...
    self.interstitalAd = [[AdLimeInterstitialAd alloc] initWithAdUnitId:(NSString *)INTERSTITIAL_ADUNITID[self.adxIndex]];
...
- (void) loadNative {
    ...
    self.nativeAd = [[AdLimeNativeAd alloc] initWithAdUnitId:(NSString *)NATIVE_ADUNITID[self.adxIndex]];
...
- (void)loadReward {
    ...
    self.rewardAd = [[AdLimeRewardedVideoAd alloc] initWithAdUnitId:(NSString *)REWARDEDVIDEO_ADUNITID[self.adxIndex]];
